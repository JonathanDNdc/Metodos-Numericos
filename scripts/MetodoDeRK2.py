...
def rk2(x0, xn, y1, y2, f1, f2, h, order):
    ...
    for x in range(1, xlist.size):
        ...
        k2y1 = h * f1(xlist[x - 1] + h, y1list[x - 1] + k1y1, y2list[x - 1] + k1y2)
        k2y2 = h * f2(xlist[x - 1] + h, y1list[x - 1] + k1y1, y2list[x - 1] + k1y2)

        y1list[x] = y1list[x - 1] + (k1y1 + k2y1) / 2
        y2list[x] = y2list[x - 1] + (k1y2 + k2y2) / 2
